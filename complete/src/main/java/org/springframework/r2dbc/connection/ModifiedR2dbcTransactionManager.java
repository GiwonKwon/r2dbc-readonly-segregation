...
import org.springframework.transaction.reactive.ModifiedAbstractReactiveTransactionManager;
...
public class ModifiedR2dbcTransactionManager extends ModifiedAbstractReactiveTransactionManager implements InitializingBean {
    ...
    /**
     * Create a new {@code ModifiedR2dbcTransactionManager} instance.
     * A {@code ConnectionFactory} has to be set to be able to use it.
     * @see #setConnectionFactory
     */
    public ModifiedR2dbcTransactionManager() {}

    /**
     * Create a new {@code ModifiedR2dbcTransactionManager} instance.
     * @param connectionFactory the R2DBC ConnectionFactory to manage transactions for
     */
    public ModifiedR2dbcTransactionManager(ConnectionFactory connectionFactory) {
        this();
     ...
     * Used as transaction object by ModifiedR2dbcTransactionManager.
     */
