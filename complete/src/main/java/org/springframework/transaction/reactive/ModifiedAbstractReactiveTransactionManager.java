...
public abstract class ModifiedAbstractReactiveTransactionManager
                                        ...
                                        .flatMap(suspendedResources -> {
                                            ...
                                            return Mono.defer(() -> {
                                                        ...
                                                        return doBegin(nestedSynchronizationManager, transaction, def)
                                                                .doOnSubscribe(ignore -> prepareSynchronization(nestedSynchronizationManager, status, def))
                                                                .doOnError(ex -> {
                                                                    nestedSynchronizationManager.clear(); // clear if needed
